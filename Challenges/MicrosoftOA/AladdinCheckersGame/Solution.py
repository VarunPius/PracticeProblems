"""
Standard DFS solution with 2 choices at each recursive step - Attacking the top left cell, and attacking the top right cell

Base case : Check if out-of-bounds, and if cell is already occupied by Aladdin's pawn, X

Keep track of pawns_beaten throughout DFS, and perform update immediately after base case, to propagate changes in MAX
"""
