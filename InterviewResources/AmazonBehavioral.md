...
Hope this helps
 ...
 STAR method is generally used to answer these types of questions, also mentioned by Amazon in their interview preparation guidelines.
S: Situation: Describe a task you were supposed to do and the situation you were in. (For example, you can start with describing your project, your team).
T: Task: Goal you wanted to achieve. (Describe the deadline of the project, what you had to perform in technicality terms, challenges faced)
A: Action: Action you took to complete the assigned task and how you solved the faced challenges. ( Can use leadership principles here).
R: Result: Results obtained from the given task, what did you accomplish, describe the positives and learning you gained from the task. ( Can use leadership principles here as well.)

-------------------------------
Apple:
- identified error and fixed it myself
-

MathWorks:
- obtained feedback from friends and tried to implement it on Matlab
- frugal in using resources: used docker container for AWS DynamoDB to save money instead of using actual resources
-

Wellington:
- created library for data processing
- Did a mistake and fixed it myself over the weekend

Tibco:
- Created script repo
- Did ethical work and went above and beyond my duty when i did and identified GDPR projects even though it was not mine
